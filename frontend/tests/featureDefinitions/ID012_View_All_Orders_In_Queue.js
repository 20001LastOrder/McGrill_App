...
Given('George Cullen is logged in as a restaurant owner', async function () {
    // Write code here that turns the phrase above into concrete actions
    return 'pending';
});


Given('George Cullen owns a restaurant George1', async function () {
    // Write code here that turns the phrase above into concrete actions
    return 'pending';
});

  Given('George1 has the following orders', async function (dataTable) {
    // Write code here that turns the phrase above into concrete actions
    return 'pending';
});
...
Then('the following items are returned', async function (dataTable) {
// Write code here that turns the phrase above into concrete actions
    return 'pending';
});